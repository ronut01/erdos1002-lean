...
of the two central coordinates.  More precisely, fix $R\ge0$ and integers
...
$\varepsilon=\e^{-\gamma H/2}$, removes the phase with error
$O(\e^{-\gamma H/2})$.
...
apply Lemma~\ref{lem:descendant} to the remaining earlier phase.
...
Let $a_i\ge1$ and let an integer sequence, not identically zero, satisfy
\[
...
Now let $E_{M,K}$ be the event that every digit in the full symmetric word
\[
...
Ibby Mian and Shayaan Siddique of Millennium Research performed an independent
pre-collaboration audit of an earlier version of this manuscript.  Their audit
was completed and published on 1 August 2026, before any collaboration
existed.  After its publication, Mian, Siddique, and the author agreed to
collaborate separately on a Lean~4 formalization of this proof as a distinct
companion project.  Any
comments from Mian or Siddique after that date are collaborator feedback, not
an additional independent referee opinion.  Mian and Siddique are not authors
of this mathematical manuscript.
